...
/***/ function(module, exports) {
	...
	Utils.prototype.vectorIntersect = function (vec0, vec1) {
	  var x0 = vec0.get("position").get("x");
	  var y0 = vec0.get("position").get("y");
	  var x1 = vec1.get("position").get("x");
	  var y1 = vec1.get("position").get("y");
	...
	Utils.prototype.collisionRect = function (r0, r1) {
	  ...
	  var r1x = r1x.get("position").get("x");
	  var r1y = r1y.get("position").get("y");
	
	  var r0w = r0x + r0x.get("width");
	  var r0h = r0y + r0y.get("height");
	  var r1w = r1x + r1x.get("width");
	  var r1h = r1y + r1y.get("height");
