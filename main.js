...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	Particle.prototype.springFromTo = function (p) {
	  ...
	  var springVec = vector.create(spring, spring);
	  var distance = this.get("position")["-"](p.get("position"));
	
	  distance.setLength(distance.getLength() - offset);
	  var springForce = distance["*"](springVec);
	...
	Particle.prototype.springToPoint = function (point) {
	  ...
	  var springVec = vector.create(spring, spring);
	  var distance = this.get("position")["-"](point);
